...
import { Building2, Users, Plus, Trash2, RefreshCw, Search, Edit, UserPlus, UserCog, KeyRound, Eye, EyeOff, Target, AlertCircle, Activity } from "lucide-react"
        ...
        <TabsList className={`w-full mx-auto ${isAdminOrManager ? 'max-w-7xl grid-cols-6' : 'max-w-md grid-cols-2'} grid bg-muted/50 p-1 rounded-lg`}>
          ...
          {isAdminOrManager && (
            <>
              ...
              <TabsTrigger value="prana-monitoring" className="text-sm font-medium rounded-md data-[state=active]:bg-blue-500 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300">
                <Activity className="mr-2 h-4 w-4" /> Activity Monitor
              </TabsTrigger>
            </>
          )}
        </TabsList>
    ...
    <SelectItem value="research">
      <div className="flex items-center">
        ...
        Research
            ...
            {isAdminOrManager && (
              <TabsContent value="prana-monitoring" className="mt-6 space-y-6">
                <Card className="border-l-4 border-blue-500 shadow-xl">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-2xl">
                      <Activity className="h-6 w-6 text-blue-500" />
                      Employee Activity & Inactivity Monitoring
                    </CardTitle>
                    <CardDescription>
                      Real-time keyboard and mouse activity tracking with separate inactivity metrics
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <PranaLiveMonitor />
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <Card className="border-l-4 border-green-500">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Employees online now</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-l-4 border-blue-500">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold text-blue-600">
                        <span id="avg-mouse-inactivity">-</span>
                      </div>
                  ...
                  <Card className="border-l-4 border-purple-500">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold text-purple-600">
                        <span id="avg-keyboard-inactivity">-</span>
                      </div>
                      <p className="text-xs text-gray-500 mt-1">Across all users</p>
                    </CardContent>
                  </Card>
                ...
                <Card>
                  ...
                  <CardContent className="flex gap-4">
                    <Button
                      onClick={() => window.location.href = '/inactivity-tracking'}
                      className="bg-blue-500 hover:bg-blue-600"
                    >
                      <Activity className="mr-2 h-4 w-4" />
                      View Detailed Inactivity Reports
                    </Button>
                    <Button
                      onClick={() => window.location.href = '/prana-demo'}
                      variant="outline"
                    >
                      Test PRANA Demo
                    </Button>
                ...
                <Card className="border-blue-200 bg-blue-50">
                  <CardHeader>
                    <CardTitle className="text-blue-900">About Activity Monitoring</CardTitle>
                  </CardHeader>
                  <CardContent className="text-sm text-blue-800 space-y-2">
                    <p><strong>🖱️ Mouse Inactivity:</strong> Time since last mouse movement, click, or scroll</p>
                    <p><strong>⌨️ Keyboard Inactivity:</strong> Time since last keypress</p>
                    <p><strong>Focus Score:</strong> Overall productivity score (0-100%)</p>
                    <p className="mt-4 text-xs">
                      💡 <strong>Tip:</strong> High keyboard inactivity with low mouse inactivity may indicate reading or research.
                      High mouse inactivity with low keyboard inactivity may indicate typing or coding work.
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
