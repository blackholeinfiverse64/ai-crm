...
import EmployeeActivityMonitor from '@/components/admin/EmployeeActivityMonitor';

export function EmployeeMonitoring() {
  const { user } = useAuth();
  const [selectedEmployee, setSelectedEmployee] = useState(null);
  const [monitoringStatus, setMonitoringStatus] = useState({});
  const [activeTab, setActiveTab] = useState('activity-tracking');
  ...
  useEffect(() => {
    ...
    // Auto-select current logged-in user to show their own PRANA activity
    if (user) {
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-6">
            ...
            <div className="lg:col-span-3">
              {selectedEmployee ? (
                <>
                  <TabsContent value="activity-tracking">
                    <EmployeeActivityMonitor employee={selectedEmployee} />
                  </TabsContent>
              ...
              {selectedEmployee && activeTab !== 'dashboard' && activeTab !== 'activity-tracking' && (
                <>
